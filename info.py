...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file_name}\n⚡ Size :- {file_size} @ibackupi @MovieHouseChannelbot  ⚠️ 𝐍𝐨𝐭𝐞: This message will be Auto-deleted after 5 minutes to avoid copyright issues.   𝙁𝙤𝙧𝙬𝙖𝙧𝙙 𝙩𝙤 𝙎𝙖𝙫𝙚𝙙 𝙈𝙚𝙨𝙨𝙖𝙜𝙚𝙨⚠️")
