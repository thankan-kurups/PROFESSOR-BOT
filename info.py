...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file_name}\n\n[ @ibackupi ] \n[ @MovieHouseChannelbot ] \n[ WhatsApp Support ] - https://whatsapp.com/channel/0029Va6B3QI4tRrukh77eY2v \n\n⚠️ 𝐍𝐨𝐭𝐞: This message will be Auto-deleted after 5 minutes to avoid copyright issues.   𝙁𝙤𝙧𝙬𝙖𝙧𝙙 𝙩𝙤 𝙎𝙖𝙫𝙚𝙙 𝙈𝙚𝙨𝙨𝙖𝙜𝙚𝙨⚠️ btn = [[InlineKeyboardButton("Jᴏɪɴ Mʏ Cʜᴀɴɴᴇʟ ✨", url=invite_link.invite_link)]]")
